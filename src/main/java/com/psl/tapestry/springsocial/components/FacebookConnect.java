package com.psl.tapestry.springsocial.components;
...
>>>>>>> 14571411296bf3dff8a6a8475fababe3d1c9c4e4
	...
	protected String getRedirectUri() {
		System.out.println("redirectURI "+resources.createEventLink(CONNECTED_EVENT).toAbsoluteURI());
	...
	protected Link createLink(final Object[] eventContext) {
		System.out.println("!!!!!!!!!!!!createLink"+resources.createEventLink(CONNECT_EVENT));
	...
	URL connect() throws MalformedURLException {
		...
		System.out.println("!!!!!!!!!!!!"+new URL(buildConnectURL(parameters)));
